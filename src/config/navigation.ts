...
import { Boxes, CalendarDays, CircleDollarSign, ClipboardList, ContactRound, FileText, Gauge, Music2, PackageOpen, Settings, SlidersHorizontal, Sparkles, UsersRound, UserRoundCog } from "lucide-react";
...
export const navigationGroups: { label: string; items: NavItem[] }[] = [
  ...
  { label: "Operación musical", items: [
    { label: "Músicos", path: "/musicos", icon: UsersRound, phase: 2 },
