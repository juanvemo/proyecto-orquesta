...
function valuesFromMusician(musician: Musician): MusicianFormValues {
  ...
  return {
    ...
    whatsapp: musician.whatsapp ?? "", email: musician.email ?? "", city: musician.city ?? "", photo_url: musician.photo_url ?? "",
