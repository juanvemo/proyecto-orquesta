...
export default function Users() {
  ...
  const confirmApproval = async () => {
    ...
    await updateMember(approvingUser, { approval_status: "APPROVED", role_id: approvalRoleId });
